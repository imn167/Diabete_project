...
/* On supprime les variables indiquant la seconde mesure de pression arterielle. 
...
/* Prévisible mais plus le temps à jeun est grand et plus les taux de glucose sont moins important
