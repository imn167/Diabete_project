...
/*Ordinales*/
title "Tableau de fréquence et Diagramme en baton pour la variable IMC codée";
...
title;
/*---------*/
title "Tableau de fréquence et Diagramme en baton pour la variable Age codée";
proc freq data=malib.diabete_fin;
tables age_code;
run;
...
title;
/*---------*/
title "Tableau de fréquence et Diagramme en baton pour la variable Hypertension codée";
proc freq data=malib.diabete_fin;
tables bp_code;
run;
...
var glyhb hdl;
run;
/*variable significativement anti-corr or corr faible = 0.15191 */

proc sgplot data=malib.diabete_fin; 
scatter X = bp_1s Y = glyhb / group= imc_code;
run;

proc sgplot data=malib.diabete_fin; 
scatter X = hdl Y = glyhb / group= bp_code;
run;
